module SNNDBSCAN
    ...
    function get_epsilon_neighbours(index::Int64, num_points::Int64, epsilon::Float64, Smat::Array{Float64,2})
        epsilon_neighbours_t = Int64[];
        for i=collect(1:num_points)
            if i == index
                continue;
            end
            if Smat[index, i] < epsilon
                #println("Smat[",index,",",i,"]=",Smat[index, i])
                continue;
            else
                push!(epsilon_neighbours_t, i)
            end
        end
        return epsilon_neighbours_t;
    end

    function dbscan(num_points::Int64, epsilon::Float64, minpts::Int64, Smat::Array{Float64,2}, point_cluster_id::Dict{Int64, Int64}, corepoints::Array{Int64,1})
        cluster_id = 1;
        for i=collect(1:num_points)
    ...
    function expand(index::Int64, cluster_id::Int64, Smat::Array{Float64,2}, num_points::Int64, epsilon::Float64, minpts::Int64, point_cluster_id::Dict{Int64, Int64})
    ...
    function spread(index::Int64, seeds::Array{Int64,1}, cluster_id::Int64, Smat::Array{Float64,2}, num_points::Int64, epsilon::Float64, minpts::Int64, point_cluster_id::Dict{Int64, Int64})
